...
/**
 * max_heap - Function that turns a binary tree into a
 * complete binary heap
 * @array: Integer array representing a binary tree
 * @size: Array size
...
/**
 * heap_sort - Functions that sort array integers using heap sorting
 * @array: Integer array
 * @size: Array size
 *
